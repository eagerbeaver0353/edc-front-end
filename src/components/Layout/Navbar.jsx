...
const Navigation = () => {
  ...
  return (
    <nav className="bg-white fixed w-full z-50 border-gray-200 dark:bg-gray-900 justify-between dark:border-gray-700">
      <div class=" flex flex-wrap items-center  justify-between md:justify-between mx-auto p-4">
        ...
        <div
          class={`items-center justify-between ${open ? 'block ' : 'hidden'} w-full md:flex md:w-auto md:order-1`}
          id="navbar-sticky"
        >
